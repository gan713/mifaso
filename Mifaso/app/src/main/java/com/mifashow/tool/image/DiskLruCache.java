...
public class DiskLruCache {
    ...
    private final int maxCacheItemSize = 1024; // 64 item default
    private long maxCacheByteSize = 100*1024*1024; // 5MB default
    private CompressFormat mCompressFormat = CompressFormat.JPEG;
    private int mCompressQuality = 100;//70
    ...
    public void remove(String key) {
    	if(!mLinkedHashMap.containsKey(key))return;
    	File f=new File(mLinkedHashMap.get(key));
    ...
    public static File getDiskCacheDir(Context context, String uniqueName) {
        ...
        final String cachePath =
        		Utils.getExternalCacheDir(context)!=null &&(Environment.getExternalStorageState() == Environment.MEDIA_MOUNTED ||
