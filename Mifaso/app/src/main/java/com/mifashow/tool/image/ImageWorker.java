...
public abstract class ImageWorker {
    ...
    public void loadImage(Object data, ImageView imageView) {
        ...
        if (mImageCache != null) {
          ...
          //gan
//            if(bitmap==null)bitmap=mImageCache.getBitmapFromDiskCache(String.valueOf(data));
        }
        ...
        if (bitmap != null) {
            ...
            task.executeOnExecutor(Executors.newSingleThreadExecutor(),data);
        }
    }
...
//                if(bitmap!=null)Log.d("-ImageWorker","gotFromDiskCache:"+data);
            }
...
//                if(bitmap!=null)Log.d("-ImageWorker","gotFromNetwork:"+data);
            }
            ...
            if(shadow>0)return drawShadow(bitmap,shadow);
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            try{
               this.finalize();
            	...
            	Log.e("-ImageWorker",Log.getStackTraceString(e));
            }
        }
